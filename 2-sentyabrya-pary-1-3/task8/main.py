...
triangle = Triangle((15, 15), 25, "жёлтый", 12)
...
print(f"Triangle: coords={triangle.coords}, width={triangle.width}, color={triangle.color}, radius={triangle.side}")

print("\n=== РИСУЕМ ФИГУРЫ (Задача 7+8) ===")
figures = [fig3, line, rect, ellipse, triangle]
